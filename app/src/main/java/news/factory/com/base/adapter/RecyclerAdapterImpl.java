...
import news.factory.com.base.view_holder.button.ButtonItemViewHolder;
import news.factory.com.base.view_holder.button_block.ButtonBlockItemViewHolder;
import news.factory.com.base.view_holder.category.CategoryViewHolder;
import news.factory.com.base.view_holder.category_item.CategoryItemViewHolder;
import news.factory.com.base.view_holder.category_title.CategoryTitleViewHolder;
import news.factory.com.base.view_holder.feature.FeatureViewHolder;
import news.factory.com.base.view_holder.image.ImageViewHolder;
import news.factory.com.base.view_holder.indicator.IndicatorViewHolder;
import news.factory.com.base.view_holder.published.PublishedViewHolder;
import news.factory.com.base.view_holder.text.TextViewHolder;
import news.factory.com.base.view_holder.title.TitleViewHolder;
import news.factory.com.base.view_holder.top_block.TopBlockViewHolder;
import news.factory.com.base.view_holder.uppertitle.UpperTitleViewHolder;
...
public class RecyclerAdapterImpl extends RecyclerView.Adapter<BaseItemViewHolder> implements RecyclerAdapter {
    ...
    public BaseItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            ...
            case R.layout.item_category_sort:
                return new CategoryItemViewHolder(view,items,objectWrapper);
            case R.layout.item_button:
                return new ButtonItemViewHolder(view,items,objectWrapper);
            case R.layout.item_category_title:
                return new CategoryTitleViewHolder(view,items,objectWrapper);
            case R.layout.item_button_block:
                return new ButtonBlockItemViewHolder(view,items,objectWrapper);
            default:
