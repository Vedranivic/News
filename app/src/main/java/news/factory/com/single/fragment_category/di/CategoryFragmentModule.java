...
public class CategoryFragmentModule {
    ...
    @Provides
    @PerFragmentScope
    public CategoryFragmentContract.View provideCategoryFragmentView(CategoryFragment categoryFragment, CategoryInteractor categoryInteractor){
        categoryFragment.getLifecycle().addObserver(categoryInteractor);
